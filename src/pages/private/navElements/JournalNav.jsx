...
const JournalNav = (props) => {
  ...
  // console.log('[JournalNav props are: ', props)
  ...
  const openSpotlightpage = ()=>{
    ...
    console.log('[JournalNav] openSpotLightPage cicked', props)
...
export default connect(mapState, actions)(JournalNav)
